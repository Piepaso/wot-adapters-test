...
import physical.TemperaturePropertyObject;
...
public class DemoShadowingFunction extends ShadowingFunction {
    ...
    protected void onDigitalTwinBound(Map<String, PhysicalAssetDescription> adaptersPhysicalAssetDescriptionMap) {
        ...
        try{
            System.out.println("["+ getId() +"] -> onDigitalTwinBound(): " + adaptersPhysicalAssetDescriptionMap);
            ...
            adaptersPhysicalAssetDescriptionMap.values().forEach(pad -> {
                pad.getProperties().forEach(property -> {
                    try {
                        ...
                        this.digitalTwinStateManager.createProperty(new DigitalTwinStateProperty<>(property.getKey(),(Object) property.getInitialValue()));
                        ...
                        System.out.println("["+ getId() +"] -> onDigitalTwinBound() -> Property Created & Observed:" + property.getKey());
                ...
                */
                ...
                pad.getEvents().forEach(event -> {
                    try {
                        ...
                        System.out.println("["+ getId() +"] -> onDigitalTwinBound() -> Event Created & Observed:" + event.getKey());
                ...
                pad.getActions().forEach(action -> {
                    try {
                        ...
                        System.out.println("["+ getId() +"] -> onDigitalTwinBound() -> Action Enabled:" + action.getKey());
                ...
                pad.getRelationships().forEach(relationship -> {
                    try{
                        if(relationship != null && relationship.getName().equals(GlobalKeywords.INSIDE_IN_RELATIONSHIP_NAME)){
                            ...
                            System.out.println("["+ getId() +"] -> onDigitalTwinBound() -> Relationship Created & Observed :" + relationship.getName());
                        }
                    }catch (Exception e){
                        e.printStackTrace();
                    }
    ...
    protected void onPhysicalAssetPropertyVariation(PhysicalAssetPropertyWldtEvent<?> physicalAssetPropertyWldtEvent) {
        ...
        try {
            ...
            System.out.println("["+ getId() +"] -> onPhysicalAssetPropertyVariation() -> Variation on Property :" + physicalAssetPropertyWldtEvent.getPhysicalPropertyId());
            ...
            */
            ...
            this.digitalTwinStateManager.updatePropertyValue(new DigitalTwinStateProperty<>(
                    physicalAssetPropertyWldtEvent.getPhysicalPropertyId(),
                    physicalAssetPropertyWldtEvent.getBody()));
            ...
            System.out.println("["+ getId() +"] -> onPhysicalAssetPropertyVariation() -> DT State UPDATE Property :" + physicalAssetPropertyWldtEvent.getPhysicalPropertyId());
    ...
    protected void onPhysicalAssetEventNotification(PhysicalAssetEventWldtEvent<?> physicalAssetEventWldtEvent) {
        try {
            ...
            System.out.println("["+ getId() +"] -> onPhysicalAssetPropertyVariation() -> Notification for Event :" + physicalAssetEventWldtEvent.getPhysicalEventKey());
            ...
            System.out.println("["+ getId() +"] -> onPhysicalAssetPropertyVariation() -> DT State Notification for Event:" + physicalAssetEventWldtEvent.getPhysicalEventKey());
